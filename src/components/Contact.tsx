...
const Contact = () => {
  return (
    <section id="kontakt" className="py-20 md:py-32 bg-gradient-to-b from-background to-card">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-card/50 backdrop-blur-sm rounded-lg p-8 border border-border hover:border-primary transition-colors">
              ...
              <h3 className="font-serif text-2xl font-bold mb-4 text-foreground">Adresse</h3>
            ...
            <div className="bg-card/50 backdrop-blur-sm rounded-lg p-8 border border-border hover:border-primary transition-colors">
              ...
              <h3 className="font-serif text-2xl font-bold mb-4 text-foreground">Kontakt os</h3>
          ...
          <div className="bg-card/50 backdrop-blur-sm rounded-lg p-8 border border-border text-center">
            <h3 className="font-serif text-2xl font-bold mb-6 text-foreground">Følg os</h3>
