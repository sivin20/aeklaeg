    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-20">
        ...
        {collections.map((collection, idx) => (
          <section key={idx} className={`py-16 md:py-24 ${idx % 2 === 1 ? 'bg-card' : ''}`}>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="font-sans text-lg text-muted-foreground leading-relaxed mb-8">
                TØRW er vores tøjbutik, hvor du finder udvalgte brands og unika pieces. 
                Vi fokuserer på kvalitet, stil og tidløst design. Butikken rummer også 
                et galleri med skiftende udstillinger af lokale kunstnere og håndværkere.
              </p>
